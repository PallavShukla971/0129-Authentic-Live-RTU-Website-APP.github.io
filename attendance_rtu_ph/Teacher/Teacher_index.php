...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red; border-right: 6px solid red; border-right: 6px solid red; " >&nbsp You are at HOD LOG-In page&nbsp </li><li>&nbsp Your Track&nbsp </li>
      <li>&#187;</li>
      <li><a href="../index.html">Home</a></li><li> &#187;  </li><li><a href="../Log-In.html">Log-In</a></li><li>&nbsp &#187; &nbsp </li><li class="current"><a href="Teacher_index.php">HOD Log-In</a></li>
    </ul>
  </div>
</div>
