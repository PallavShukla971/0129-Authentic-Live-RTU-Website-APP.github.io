...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red; border-right: 6px solid red; " >&nbsp You are at Take Attendence page&nbsp </li><li>&nbsp Your Track&nbsp </li>
      <li>&#187;</li>
	  <li><a href="../index.html">Home</a></li><li> &#187;  </li><li><a href="../Log-In.html">Log-In</a></li><li> &#187; </li><li><a href="Teacher_index.php">HOD Log-In</a></li><li>&nbsp &#187; &nbsp </li><li  class="current" ><a href="TakeAttendence.php">Take Attendance page</a></li>
...
<!--delted image-->
	...
	-->
<form method="post"  action="TakeAttendence.php">
...
$query="select * from timetable";
	...
	while($n>0) //Valid user and password
	{
		...
		?>
		<option value="<?php echo $subno."|".$sem."|".$branch."|".$batch?>"><?php echo $subject1."/".$sem."/".$branch."/".$batch?></option>
...
<tr><td >Subject Code</td><td><input type="text" name="subno" size="30" value="<?php echo $subject; ?>" readonly="readonly"/></td></tr>
<tr><td>batch</td><td><input type="text" name="batch" size="30" value="<?php echo $batch; ?>" readonly="readonly"/></td></tr>
<tr><td>Sem</td><td><input type="text" name="sem" size="30" value="<?php echo $sem; ?>" readonly="readonly"/></td></tr>
<tr><td>branch</td><td><input type="text" name="branch" size="30" value="<?php echo $branch; ?>" readonly="readonly"/></td></tr>
<tr><td>No Of Student</td><td><input type="text" name="noofs" size="30" value="<?php echo $n; ?>" readonly="readonly"/></td></tr>

<tr><td><h4>S.NO</h4></td><td><h4>NAME</h4></td><td><h4>ROLL NO</h4></td><td><h4>BATCH</h4></td>
<td><h4>Attendence</h4></td>
</tr>
<?php
$i=1;
while($rw=mysqli_fetch_array($result))
{
    ...
    <td><?php echo $sem."-".$branch."-".$batch1; ?></td>
    <td><input type="checkbox" id="<?php echo $i; ?>" name="<?php echo $i; ?>"
         checked>
  </td>
    </tr>
...
<tr><td align="center" colspan="5"><input type="submit" value="Submit Attendance" name="B2" /></td></tr>
</table>
...
if(isset($_REQUEST["B2"]))
{
	...
	$atten=$atten."]";
	$today = date("d/m/Y"); 
$id=GenerateId("atten",1);

$sql="insert into atten values('$id','$subno','$atten','$today','$batch','$sem','$branch')";


if(mysqli_query($cn,$sql))
{
	echo "response is updated";
}
else
{
	echo "Data Not Saved";
