...
$result=$_REQUEST["subno"];
			...
			$subject=$result_explode[1];
            

//$sub=$_REQUEST["subno"];
//$subtype=$_REQUEST["subtype"];
$time=$_REQUEST["time"];
$tday1=$_REQUEST["tday1"];
$tday2=$_REQUEST["tday2"];
$tday3=$_REQUEST["tday3"];
$vday1=$_REQUEST["vday1"];
$vday2=$_REQUEST["vday2"];
$vday3=$_REQUEST["vday3"];
$day1=$_REQUEST["day1"];
$day2=$_REQUEST["day2"];
$day3=$_REQUEST["day3"];

$session=$_REQUEST["session"];
$id=GenerateId("timetable",1);
//$limit=$_REQUEST["limit"];


$sql="insert into timetable values('$id','$fname','$subno','$sem','$session','$tday1','$tday2','$tday3','$day1','$day2','$day3','$vday1','$vday2','$vday3','$batch','$subject','$branch','$time')";


if(mysqli_query($cn,$sql))
{
	echo "Time table data saved";
}
else
{
	echo "Data Not Saved";
