...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red; border-right: 6px solid red; " >&nbsp You are at Add Subject page&nbsp </li><li>&nbsp Your Track&nbsp </li>
      <li>&#187;</li>
...
<tr><td>Subject Name</td><td><input type="text" name="name" size="30" value="" required/></td></tr>
<tr>
  <td>Subject code.</td><td><input type="text" name="subno" size="30" value="" required /></td></tr>
<tr>
  <td>Max marks.</td><td><input type="number" name="maxno" size="30" value="" required/></td></tr>
...
<tr><td>Sub. Type</td><td> <select name="type" required>
			<option value="theory">Theory</option>
            <option value="lab">Lab</option>
					</select> </td></tr>    
                    
<tr><td>Slot</td><td> <select name="slot" required>
			<option value="1">1</option>
            <option value="2">2</option>
             <option value="2">3</option>
					</select> </td></tr>          
<tr><td align="center" colspan="2"><input type="submit" value="Add Subject" name="b1" /></td></tr>
