...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red;" >&nbsp You Are Here</li>
      <li>&#187;</li>
...
<tr><td>Student Name</td><td><input type="text" name="name" size="30" value="" required/></td></tr>
<tr><td>Roll No.</td><td><input type="text" name="roll" size="30" value="" required/></td></tr>
<tr><td>Mobile.</td><td><input type="number" name="phone" size="30" value="" required/></td></tr>
<tr><td>Email</td><td><input type="email" name="email" size="30" value="" required/></td></tr>
<tr><td>Year Of Addmission</td><td> <select name="yoa" required>
...
<tr><td align="center" colspan="2"><input type="submit" value="Add Student" name="b1" /></td></tr>
</table>
</form>  
