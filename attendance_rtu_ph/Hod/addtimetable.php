...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red; border-right: 6px solid red; " >&nbsp You are at Add time table page&nbsp </li><li>&nbsp Your Track&nbsp </li>
      <li>&#187;</li>
...
<tr><td> Faculty</td> <td><select name="fno" id="fno">
...
$query="select * from subjectt";
	...
	while($n>0) //Valid user and password
	{
		...
		$id=$rw["subno"];
		?>
		<option value="<?php echo $id."|".$name?>"><?php echo $name."[".$id."]"?></option>
...
<tr><td>Semester</td><td> <select name="sem" required>
...
<tr><td>Branch</td><td> <select name="branch" required>
            ...
            <option value="12">IT-12</option>
			<option value="1234">CS-1234</option>
			
			
					</select> </td></tr>

<tr><td>Session</td><td> <select name="session" required>
			<option value="2018-2019">2018-2019</option>
					</select> </td></tr> 
                      <tr><td>Time</td><td> <select name="time" required>
			<option value="1">1</option>
			<option value="2">2</option>
            <option value="3">3</option>
                       ...
                       <tr><td>Day-1</td><td>Time-1 <select name="tday1" required>
            ...
            <option value="no">No</option>
					...
					</select>  Day-1<select name="day1" required>
            ...
            <option value="no">No</option>
                    ...
                    Venue-1 <select name="vday1" required>
            ...
            <option value="no">No</option>
                      ...
                      <tr><td>Day-2</td><td>Time-2 <select name="tday2" required>
			<option value="10">10</option>
			<option value="10:55">10:55</option>
            <option value="11:50">11:50</option>
            <option value="12:45">12:45</option>
            ...
            <option value="no">No</option>
					...
					</select>  Day-2<select name="day2" required>
			<option value="Monday">Monday</option>
			<option value="Tuesday">Tuesday</option>
            <option value="Wednesday">Wednesday</option>
            <option value="Thursday">Thursday</option>
            ...
            <option value="no">No</option>
                    ...
                    Venue-2 <select name="vday2" required>
			<option value="106">106</option>
			<option value="110">110</option>
            <option value="113">113</option>
            <option value="no">No</option>
                      ...
                      <tr><td>Day-3</td><td>Time-3 <select name="tday3" required>
			<option value="10">10</option>
			<option value="10:55">10:55</option>
            <option value="11:50">11:50</option>
            <option value="12:45">12:45</option>
            ...
            <option value="no">No</option>
					...
					</select>  Day-3<select name="day3" required>
			<option value="Monday">Monday</option>
			<option value="Tuesday">Tuesday</option>
            <option value="Wednesday">Wednesday</option>
            <option value="Thursday">Thursday</option>
            ...
            <option value="no">No</option>
                    ...
                    Venue-3 <select name="vday3" required>
			<option value="106">106</option>
			<option value="110">110</option>
            <option value="113">113</option>
            <option value="no">No</option>
...
<tr><td align="center" colspan="2"><input type="submit" value="Add Timetable" name="b1" /></td></tr>
</table>
</form>  
