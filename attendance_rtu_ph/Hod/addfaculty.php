...
<div class="wrapper col2">
  <div id="header">
    <div id="logo">
      ...
      <h2><a href="index.html">RTU (MANAGER)</a></h2>
    ...
    <div id="topnav">	
      <ul>
        <li class="active"><a href="index.html">Home</a>
         ...
         <li><a href="addsubject.php">ADD SUBJECT</a></li><!-- Style Demo  -->
       <li><a href="addfaculty.php">ADD FACULTY</a></li>
				<li><a href="addtimetable.php">ADD TIME TABLE</a></li>
...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red; border-right: 6px solid red; " >&nbsp You are at Add faculty page&nbsp </li><li>&nbsp Your Track&nbsp </li>
      <li>&#187;</li>
      <li><a href="index.html">Home</a></li><li>&nbsp &#187; &nbsp </li><li><a href="Log-In.html">Log-In</a></li><li>&nbsp &#187; &nbsp </li><li  class="current" ><a href="Log-In.html">HOD Log-In</a></li>
    </ul>
  </div>
</div>
...
<tr><td>Faculty Name</td><td><input type="text" name="name" size="30" value="" required/></td></tr>
<tr><td>Faculty No.</td><td><input type="text" name="fno" size="30" value="" required/></td></tr>
<tr><td>Email</td><td><input type="email" name="email" size="30" value="" required/></td></tr>
<tr><td>Mobile.</td><td><input type="number" name="mobile" size="30" value="" required/></td></tr>
<tr><td>Department</td><td> <select name="dept" required>
			<option value="cs">CS</option>
			<option value="it">IT</option>
					</select> </td></tr>

<tr><td>Designation</td><td> <select name="desg" required>
			<option value="Professor">Professor</option>
			<option value="Assistant Professor">Assistant Professor</option>
            <option value="Associate Professor">Associate Professor</option>
			<option value="Guest Faculty">Guest Faculty</option>
					</select> </td></tr>
 <tr><td>Screat No</td><td><input type="sno" name="sno" size="30" value="" required/></td></tr
<tr><td align="center" colspan="2"><input type="submit" value="Add faculty" name="b1" /></td></tr>
</table>
</form> 
<form method="post"  action="Teacher_index.php">
<table width="500" border="1" align="center"  cellpadding="4px">

<a href="Teacher_index.php"><button type="submit" class="btn" >Login</button></a>
<tr><td align="center" colspan="2"><a href="Teacher_index.php"><input type="submit" value="Back Button" name="B211" /></a></td></tr>
<a href="Teacher_index.php"><button onclick="goBack()">Go Back</button></a>
...
function goBack() {
  window.history.back();
		...
		<table width="500" border="1" align="center"  cellpadding="4px">
			<tr>
				<th align="center" colspan="0"><a href="../index.html"><button>Back_Button</button></a></th>
