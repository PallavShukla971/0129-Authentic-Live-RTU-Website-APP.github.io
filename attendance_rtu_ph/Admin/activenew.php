...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red; border-right: 6px solid red; " >&nbsp You are at Active New page&nbsp </li><li>&nbsp Your Track&nbsp </li>
      <li>&#187;</li>
      <li><a href="../index.html">Home</a></li><li> &#187;  </li><li><a href="../Log-In.html">Log-In</a></li><li> &#187; </li><li><a href="Admin_index_Login.php">ADMIN Log-In</a></li><li>&nbsp &#187; &nbsp </li><li  class="current" ><a href="activenew.php">Active New</a></li>
    </ul>
  </div><!--
  <style>
div#breadcrumb li:hover {
  ...
  text-decoration: underline;
	...
	<marquee width="" behavior="scroll" height="" direction="left" scrollamount="10" 
			 onmouseover="this.stop();" onmouseout="this.start();"> <font face="sansserif" color="red"
			 size="5">You are at ADMIN HOME page</font>
...
<form method="post"  action="activenew.php">
...
<tr><td align="center" colspan="6"><input type="submit" value="Active" name="B2" /></td></tr>
</table>
<?php
require_once("../Library/MyLib.php");
if(isset($_REQUEST["B2"]))
