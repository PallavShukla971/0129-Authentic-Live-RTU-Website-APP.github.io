...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      <li class="first"   style="border-left: 6px solid red; border-right: 6px solid red; " >&nbsp You are at Admin page&nbsp </li><li>&nbsp Your Track&nbsp </li>
      <li>&#187;</li>
      <li><a href="../index.html">Home</a></li><li> &#187;  </li><li><a href="../Log-In.html">Log-In</a></li><li>&nbsp &#187; &nbsp </li><li  class="current" ><a href="Admin_index_Login.php">ADMIN Log-In</a></li>
    </ul>
  </div>
</div>
<div>
    ...
    <div id="services" >
      <!--<ul>
		...
		<table width="500" border="1" align="center"  cellpadding="4px">
			<tr>
				<th align="center" colspan="0"><a href="../Log-In.html"><button>Back_Button</button></a></th>
